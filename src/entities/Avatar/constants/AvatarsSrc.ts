...
AvatarSrc.set("avatar1", Avatar1)
AvatarSrc.set("avatar2", Avatar2)
AvatarSrc.set("avatar3", Avatar3)
AvatarSrc.set("avatar4", Avatar4)
AvatarSrc.set("avatar5", Avatar5)
AvatarSrc.set("avatar6", Avatar6)
AvatarSrc.set("avatar7", Avatar7)
AvatarSrc.set("noAvatar", NoAvatar)
